...
stan_diagnostics <- list(
  ...
  pick2_model = list(
    ...
    upside_prob      = round(mean(pick2_draws$upside_prob), 3),
    ...
    curve_type = "Bayesian second-round right-skew hurdle: adjacent-pick P(play), shifted-lognormal played outcomes, and global rare-upside component"
  ),
  markov_model = list(

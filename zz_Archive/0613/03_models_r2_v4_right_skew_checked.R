...
PICK_MODEL_R2_HURDLE_PATH     <- c("02_models/pick_play_r2_v4_right_skew_checked.stan", "pick_play_r2_v4_right_skew_checked.stan")
...
R2_WS_FLOOR <- min(-8, min(pick_fit_data_r2$ws4[pick_fit_data_r2$played == 1], na.rm = TRUE) - 0.25)

...
# VERSION NOTE (v44 — restore plot logos, single-pick spacing, trade empty-state polish):
...
server <- function(input, output, session) {
  ...
  prob_box <- function(title, stat, col) {
    ...
    tags$div(style = sprintf(
      "flex:0 0 142px; width:142px; max-width:142px; min-width:142px; padding:8px; border:1px solid #1a1a2a; border-radius:8px; border-left:3px solid %s;", col),

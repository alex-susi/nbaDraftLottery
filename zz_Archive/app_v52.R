    ...
    div(class = "about-page",
      ...
      layout_columns(
        ...
        card(class = "about-card",
          ...
          tags$p(tags$strong("Pick Landscape "), "A high-level view of each team's pick quantity, pick quality, and total portfolio value."),
          tags$p(tags$strong("Full Table "), "Impact of the 3-2-1 Lottery on each team's pick portfolio, including a summary of the most affected picks."),
          tags$p(tags$strong("Single Pick "), "A distribution view for an individual asset."),
          tags$p(tags$strong("Pick Movers "), "Impact of the 3-2-1 Lottery on every individual pick."),
          tags$p(tags$strong("Trade Machine "), "Evaluate a real or hypothetical transaction. Select picks from each team, attach protections or swap rights, and compare expected asset value, realized outcome simulations, and best-player probabilities side by side.")
        )
      )
    )
  ),

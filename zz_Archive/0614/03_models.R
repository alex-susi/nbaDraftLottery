...
PICK_MODEL_RW_SIGMA_PATH       <- "02_models/picks_Round1.stan"
PICK_MODEL_R2_HURDLE_PATH      <- "02_models/pick_play_r2_v6_declining_upside.stan"
...
# generated vector ws4_pred_sd[1:30] / transformed vector sigma_pick[1:30].
...
pick_mu_draws <- extract_stan_vector_draws(pick_fit, "ws4_pred", 30L)
pick_sd_draws <- extract_stan_vector_draws(pick_fit, "ws4_pred_sd", 30L)
...
sigma_draws <- as.matrix(pick_fit$draws("ws4_pred_sd", format = "draws_matrix"))

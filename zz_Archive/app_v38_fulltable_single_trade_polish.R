...
server <- function(input, output, session) {
  ...
  trade_density_plot <- function(x, teamA, teamB, x_title, hover_label = "Net") {
    ...
    p %>% layout(
      paper_bgcolor = "rgba(0,0,0,0)", plot_bgcolor = "#f4f5f9",
      font = list(family = "IBM Plex Mono", color = "#1f2430"),
      xaxis = list(title = x_title, gridcolor = "#d7dbe7", zerolinecolor = "#6b7280"),
      yaxis = list(title = "Density", gridcolor = "#d7dbe7"),
      showlegend = FALSE,

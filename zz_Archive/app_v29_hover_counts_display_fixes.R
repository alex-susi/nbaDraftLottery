  ...
  output$impact_chart <- renderPlotly({
    ...
    for (i in seq_len(nrow(df))) {
      ...
      p <- p %>% add_markers(
        ...
        marker = list(color = "rgba(255,255,255,0.01)", size = 42, line = list(color = "rgba(255,255,255,0)", width = 0)),
        text = ~hover_text,
        hovertemplate = "%{text}<extra></extra>",
  ...
  output$wl_dumbbell <- renderPlotly({
    ...
    for (i in seq_len(nrow(df))) {
      ...
      p <- p %>% add_segments(
        ...
        hoverlabel = list(bgcolor = row_i$col[1], font = list(color = "white")),
        showlegend = FALSE
      )
      ...
      p <- p %>% add_markers(
        ...
        marker = list(color = "rgba(255,255,255,0.01)", size = 22, line = list(color = "rgba(255,255,255,0)", width = 0)),
        text = ~hover_text, hovertemplate = "%{text}<extra></extra>",
        hoverlabel = list(bgcolor = row_i$col[1], font = list(color = "white")),
        showlegend = FALSE, opacity = 0.01
      )
      ...
      p <- p %>% add_markers(
        ...
        marker = list(color = row_i$col[1], size = 9, opacity = 0.95, line = list(color = "#0a0a14", width = 1.3)),
        text = ~hover_text, hovertemplate = "%{text}<extra></extra>",
        hoverlabel = list(bgcolor = row_i$col[1], font = list(color = "white")),
        showlegend = FALSE
      )

...
server <- function(input, output, session) {
  ...
  output$team_detail <- renderUI({
    ...
    card(class = "team-detail-card",
      card_header(style = sprintf("border-left:3px solid %s; padding-top:8px; padding-bottom:8px;", detail_primary_col),
  ...
  output$tm_verdict <- renderUI({
    ...
    signed_metric_card <- function(mean_to_A, q05_to_A, q95_to_A, label) {
      ...
      tags$div(style = sprintf(paste0(
        ...
        "display:flex; align-items:center; gap:14px; justify-content:flex-start; box-sizing:border-box;"), metric_col),
    ...
    tags$div(style = "font-size:13px; color:#bbb; line-height:1.7;",
      tags$div(
        ...
        metric_block(
          ...
          prob_card(sprintf("%s higher EPV", input$tm_teamA), pA_ev, team_secondary_color_app(input$tm_teamA)),
          prob_card(sprintf("%s higher EPV", input$tm_teamB), pB_ev, team_secondary_color_app(input$tm_teamB)),
        ...
        metric_block(
          ...
          prob_card(sprintf("%s more 4-Yr WS", input$tm_teamA), pA_outcome, team_secondary_color_app(input$tm_teamA)),
          prob_card(sprintf("%s more 4-Yr WS", input$tm_teamB), pB_outcome, team_secondary_color_app(input$tm_teamB)),

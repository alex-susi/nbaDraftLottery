...
**Round 2 pick curve** (`pick_play_r2_v6_declining_upside.stan`) — a **hurdle model** (most second-rounders never produce), with a shifted right-skewed lognormal mixture and a pick-declining rare-upside probability $u_p$:
